...
class Test_update(unittest.TestCase):
    ...
    def test_valid_date(self):
        result1 = update.valid_date('2020-11-20')
        result2 = update.valid_date('2002020-123-200')
        self.assertEqual(result1,'2020-11-20')
        self.assertEqual(result2,'')

    def test_valid_time(self):
        result1 = update.valid_time('12:05')
        result2 = update.valid_time('132:102')
    ...
    def test_valid_date_checker(self):
        text = io.StringIO()
        sys.stdout = text
        result1 = update.valid_date_checker()

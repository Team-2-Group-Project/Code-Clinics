...
def insert_event(service, user_name, td):
    ...
    try:
        service.events().insert(calendarId='primary', body=event, maxAttendees=2, sendUpdates='all', sendNotifications=True).execute()
